      ...
      <div className='w-[100vw] h-[100vh] bg-gradient-to-b from-[#141414] to-[#0c2025] text-[white] flex flex-col items-center justify-start'>
        ...
        <main className='flex-1 w-full flex flex-col items-center justify-center gap-6 px-4'>
          ...
          <div className='max-w-[500px] w-[90%] bg-[#00000025] border-[1px] border-[#96969635] backdrop-blur-2xl rounded-lg shadow-lg flex items-center justify-center p-8'>
            <form className='w-full flex flex-col items-center justify-start gap-5' action="">
  
              <div className='w-full'>
                <label className='block text-sm font-medium mb-2'>Email</label>
                <input type='email' placeholder='Enter your email' className='w-full px-4 py-2 bg-[#1a1a1a] border border-[#96969635] rounded-lg text-white placeholder-gray-400 focus:outline-none focus:border-[#42656cae]' />
              </div>
              ...
              <div className='w-full text-center text-sm text-gray-400 mt-4'>
                You haven't any account? <span className='text-[#5a7a8f] cursor-pointer hover:text-[#5a7a8f]' onClick={() => navigate('/signup')}>Create New Account</span>
              </div>
            </form>
          </div>
        </main>
